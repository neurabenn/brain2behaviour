...
from brain2behaviour.dataset import b2b_Dataset      # <-- fix case
from brain2behaviour.preprocessing.clean_dataset import clean_dataset
...
def get_fold_features(
    ...
    data = b2b_Dataset.load(datapath)            # <-- fix class name
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--dataset", type=Path, required=True,
                        help="Path to pickled b2b_Dataset")
